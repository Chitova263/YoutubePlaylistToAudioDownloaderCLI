...
var rootCmd = &cobra.Command{
	...
	Long: `ytpdl downloads videos from a YouTube playlist and converts them
into audio files (e.g. mp3, wav) for offline listening.

Example:
  ytpdl download --url "https://youtube.com/playlist?list=XXXX" --format mp3 --output ./downloads`,
